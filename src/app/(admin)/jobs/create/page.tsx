        ...
        <div className="max-w-7xl mx-auto p-6">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-base-content/60 text-sm mt-1">
                Fill out the form to post a new job opportunity and attract
          ...
          <div className="bg-base-200 p-6 rounded-lg mb-8">
            ...
            <ul className="list-disc pl-6 text-base-content/80">
              <li>
                Provide a clear and detailed job description to help candidates
                understand the role and responsibilities.
              </li>
              <li>
                Specify the required qualifications, skills, and experience to
                attract the right candidates.
              </li>
              <li>
                Include information about the company, work environment, and
