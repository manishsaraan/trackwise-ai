			...
			<div className="max-w-2xl w-full">
				...
				<div className="card bg-base-100 shadow-xl">
					<div className="card-body items-center text-center">
						...
						<h1 className="card-title text-2xl font-bold mb-2">Application Submitted!</h1>
						<p className="text-base-content/70 mb-6">
							Thank you for your application. Our AI is now processing your information.
						</p>
						...
						<div className="w-full space-y-4 mb-8">
							<div className="flex items-center gap-4 text-success">
								...
								<div className="flex-1 text-left">
									...
									<p className="text-sm text-base-content/70">Your application has been successfully submitted</p>
								</div>
							</div>
							...
							<div className="flex items-center gap-4 text-primary">
								...
								<div className="flex-1 text-left">
									...
									<p className="text-sm text-base-content/70">Our AI is analyzing your application</p>
								</div>
							</div>
							...
							<div className="flex items-center gap-4 text-base-content/50">
								...
								<div className="flex-1 text-left">
									...
									<p className="text-sm text-base-content/70">Your application will be reviewed by the hiring team</p>
								</div>
							</div>
						</div>
						...
						<div className="bg-base-200 rounded-lg p-6 w-full mb-6">
							...
							<ul className="space-y-3">
								...
								<li className="flex items-start gap-3">
									...
									<span className="text-sm">We&apos;ll notify you when the AI processing is complete</span>
								</li>
								<li className="flex items-start gap-3">
