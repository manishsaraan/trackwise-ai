        ...
        <div className="hero-content text-center">
          <div className="max-w-4xl">
            ...
            <p className="font-body text-xl text-base-content/70 mb-8 leading-relaxed max-w-2xl mx-auto">
              An open-source Applicant Tracking System powered by AI. Streamline
              your hiring process with intelligent candidate screening and
      ...
      <section className="py-16 bg-base-200/50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-base-content/70 max-w-2xl mx-auto">
              Powered by the latest and most reliable technologies in the
              industry
            </p>
          </div>
      ...
      <section className="py-24 bg-base-200">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-base-content/70 max-w-2xl mx-auto">
              An open-source solution that combines the power of AI with the
              flexibility of community-driven development.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card bg-base-100 shadow-lg hover:shadow-xl transition-shadow">
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Reduce manual screening time by 75%. Our automated candidate
                  assessment and ranking system helps you focus on the best
                  matches, making your hiring process efficient.
                </p>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-lg hover:shadow-xl transition-shadow">
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Make informed decisions with detailed analytics about your
                  hiring pipeline and candidate quality. Track key metrics and
                  improve your hiring process continuously.
                </p>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-lg hover:shadow-xl transition-shadow">
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Advanced matching algorithms ensure you find candidates who
                  truly fit your requirements. Get detailed candidate
                  assessments and compatibility scores.
                </p>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-lg hover:shadow-xl transition-shadow">
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Never miss promising talent. Our intelligent tracking system
                  ensures every qualified candidate gets proper attention and
                  timely responses.
                </p>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-lg hover:shadow-xl transition-shadow">
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Stay informed with real-time application status updates. Track
                  candidate progress and get notifications about important
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-base-content/70">
                      Fully open-source and free to use. Host it yourself or
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-base-content/70">
                      Built with modern technologies. Easy to customize and
                      extend.
                    </p>
                  </div>
                </div>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-base-content/70 mb-8 max-w-2xl mx-auto">
            Be part of the future of hiring technology. Contribute, customize,
            and build with us.
          </p>
      ...
      <footer className="bg-base-200">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="border-t border-base-300 py-6 text-sm text-center text-base-content/60">
            <p>
              © {new Date().getFullYear()} ApplicantAI. Open Source Project
              under MIT License
            </p>
          </div>
        </div>
